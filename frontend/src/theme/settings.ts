...
export const themeSettings: App.Theme.ThemeSetting = {
  ...
  tab: { visible: true, cache: true, height: 48, mode: 'button' },
  ...
  tokens: {
    light: {
      ...
      boxShadow: {
        header: '0 2px 8px rgb(0, 21, 41, 0.08)',
        sider: '2px 0 8px 0 rgb(29, 35, 41, 0.05)',
        tab: '0 2px 8px rgb(0, 21, 41, 0.08)'
      }
    },
    dark: {
      colors: {
        container: 'rgb(39, 39, 42)',
        layout: 'rgb(24, 24, 27)',
        'base-text': 'rgb(241, 241, 241)'
      }
    }
  }
};
